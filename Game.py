                    ...
                    for each in enemybulletsGroup:
                        if each.being:
                            if pygame.sprite.collide_rect(tank_player.bullet, each):
                                ...
                                screen.blit(boom_images[0], (3 + each.rect.left * 12 * 24, 53))
                        ...
                        if each.being:
                            if pygame.sprite.collide_rect(tank_player.bullet, each):
                                ...
                                if each.blood < 0:
                                    ...
                                    # 爆炸特效
                                    if each.being is False:
                                        if each.times > 0:
                                            each.times -= 1
                                            if each.times <= 10:
                                                screen.blit(boom_images[0], (3 + each.rect.x * 12 * 24, 53))
                                            elif each.times <= 20:
                                                screen.blit(boom_images[1], (3 + each.x * 12 * 24, 53))
                                            elif each.times <= 30:
                                                screen.blit(boom_images[2], (3 + each.x * 12 * 24, 53))
                                            elif each.times <= 40:
                                                screen.blit(boom_images[3], (3 + each.x * 12 * 24, 53))
                                            elif each.times <= 50:
                                                screen.blit(boom_images[4], (3 + each.x * 12 * 24, 53))
                                            elif each.times <= 60:
                                                screen.blit(boom_images[5], (3 + each.x * 12 * 24, 53))
                                        else:
                                            each.being = False
                                    enemytanks_now -= 1
                                    enemytanks_dead += 1
